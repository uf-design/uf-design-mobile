    ...
    paginationFetchingView = () => {
        ...
        return (
            <View style={styles.fetchingView}>
                <Text style={[styles.paginationViewText, { color: this.props.styles.extra.color }]}>{this.props.waitingSpinnerText}</Text>
            </View>
        );
    };
        ...
        if (this.props.pagination) {
            ...
            return (
                <View style={styles.paginationView}>
                    <Text style={[styles.allLoadedText, { color: this.props.styles.extra.color }]}>
            ...
            if (this.props.autoPagination) {
                ...
                return (
                    <View style={styles.paginationView}>
                        ...
                        <Text
                            style={[styles.paginationViewText, { marginLeft: 5 }, { color: this.props.styles.extra.color }]}>{this.props.waitingSpinnerText}</Text>
                    </View>
                );
            }
        }
        ...
        if (this.props.refreshable && this.props.refreshableMode === 'advanced') {
            return (
                <RefreshableScrollView
                    {...props}
                    dateStyle={{ color: this.props.styles.extra.color }}
