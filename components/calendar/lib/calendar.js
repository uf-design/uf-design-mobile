...
export default class Calendar extends Component {
  ...
  selectAndJumpToToday() {
    ...
    const newMoment = moment(this.state.currentMonthMoment).set(
      "month",
      today.getMonth()
    );
    this.setState({
          ...
          this.renderDay({
            ...
            onPress: () => {
              ...
              this.props.onDateSelect &&
                this.props.onDateSelect(
                  thisMoment ? thisMoment.format() : null
                );
            },
  ...
  render() {
    ...
    const numOfWeeks =
      this.props.calendarFormat === "weekly"
        ? 1
          ...
          <ScrollView
            ...
            style={{
              height: this.state.rowHeight
                ? this.state.rowHeight * numOfWeeks
                : null
            }}
          >
